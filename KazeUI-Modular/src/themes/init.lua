-- Siguraduhing may paglalagyan ang module registration upang hindi mag-index nil
if typeof(Modules) == "nil" then
    _G.Modules = _G.Modules or {}
end

local ModulesTable = Modules or _G.Modules or {}

ModulesTable["src/themes/init"] = function()
    local ThemesModule = {}
