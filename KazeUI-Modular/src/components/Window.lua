...
function WindowModule:CreateWindow(config, screenGui)
	...
	-- GANAP NA DYNAMIC: Walang mahabang listahan ng themes dito.
	-- Ang ThemesModule na ang bahalang mag-resolve ng kahit anong ipasang string o fallback!
	ThemesModule:SetTheme(config.Theme or "Obsidian")

	-- GANAP NA DYNAMIC: Direktang tinatawag ang SetGlow na nakaturo sa Presets o custom Color3!
	if config.Glow then
	...
	-- Tagapamahala ng Config (Config Manager)
